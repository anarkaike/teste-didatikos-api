...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | As seguintes linhas de linguagem contêm as mensagens de erro padrão usadas pelo
    ...
    */
    ...
    'date_format' => 'O campo :attribute deve coincidir com o formato :formato.',
    ...
    | especificar uma linha de idioma específica personalizada para uma regra de atributo dada.
    |
    */
    ...
    | por algo mais fácil de entender, como "Endereço de E-mail" em vez de "email". Isso simplesmente nos ajuda a tornar nossa mensagem mais expressiva.
    |
    */
